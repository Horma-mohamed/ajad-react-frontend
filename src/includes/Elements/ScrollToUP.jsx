...
export default function ScrollToUp(){
    ...
    return(
        <motion.div onClick={()=>{window.scrollTo({top:0,behavior:'smooth'})}} initial={{opacity:0,y:-10}} animate={control} className="md:px-4  p-4 md:py-2 border cursor-pointer flex justify-center md:space-x-2 items-center hover:text-white hover:bg-orange-400 transform duration-200 rounded-full border-orange-400 text-orange-400 fixed bottom-20 right-10 z-[99999999]">
