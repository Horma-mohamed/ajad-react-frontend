    ...
    <>
        <motion.nav id='navbar'  className={` fixed w-full lg:h-auto h-auto  to-transparent  backdrop   top-0 z-[9999] transform duration-500 ${fixed?'  backdrop-blur border- bg-gray-50 bg-opacity-50  border-gray-300 shadow-lg':''} `} >
            ...
            <div className=" md:flex space-x-3 items-center  hidden">
                <NavLink to='/' exact ><div className=" text-center pl-2"     ><span id='menuitem' className={`${fixed?'text-gray-700':page=='home'?'text-gray-50':'text-gray-500'}  px-2 py-2  text-[15px] font-[500]  relative before:absolute before:-bottom-1 before:w-0 before:h-0.5 before:bg-orange-400  before:transform before:duration-500 hover:before:w-[20px] before:left-[50%] before:right-[50%] ${page=='home'?'before:w-[20px]':''} text-center `} >Home</span></div></NavLink>
                <NavLink to='/blog' exact ><div className=" text-center pl-2"     ><span id='menuitem' className={`${fixed?'text-gray-700':page=='home'?'text-gray-50':'text-gray-500'}  px-2 py-2  text-[15px] font-[500]  relative before:absolute before:-bottom-1 before:w-0 before:h-0.5 before:bg-orange-400  before:transform before:duration-500 hover:before:w-[20px] before:left-[50%] before:right-[50%] ${page=='blog'?'before:w-[20px]':''} text-center `} >Blog</span></div></NavLink>
                <NavLink to='/about' exact ><div className=" text-center pl-2"     ><span id='menuitem' className={`${fixed?'text-gray-700':page=='home'?'text-gray-50':'text-gray-500'}  px-2 py-2  text-[15px] font-[500]  relative before:absolute before:-bottom-1 before:w-0 before:h-0.5 before:bg-orange-400  before:transform before:duration-500 hover:before:w-[20px] before:left-[50%] before:right-[50%] ${page=='about'?'before:w-[20px]':''} text-center ` }>Who are we</span></div></NavLink>
                <NavLink to='/gallery' exact ><div className=" text-center pl-2"     ><span id='menuitem'  className={`${fixed?'text-gray-700':page=='home'?'text-gray-50':'text-gray-500'}  px-2 py-2  text-[15px] font-[500]  relative before:absolute before:-bottom-1 before:w-0 before:h-0.5 before:bg-orange-400  before:transform before:duration-500 hover:before:w-[20px] before:left-[50%] before:right-[50%] ${page=='gallery'?'before:w-[20px]':''} text-center ` }>Gallery</span></div></NavLink>
                <NavLink to='/contact' exact ><div className=" text-center pl-2"     ><span id='menuitem'  className={`${fixed?'text-gray-700':page=='home'?'text-gray-50':'text-gray-500'}  px-2 py-2  text-[15px] font-[500]  relative before:absolute before:-bottom-1 before:w-0 before:h-0.5 before:bg-orange-400  before:transform before:duration-500 hover:before:w-[20px] before:left-[50%] before:right-[50%] ${page=='contact'?'before:w-[20px]':''} text-center ` }> Contact</span></div></NavLink>
            </div>
            <button className={`  relative group  bg-orange-4000 border-[1.6px] ${fixed?'border-orange-400':page=='home'?'lg:border-white border-orange-400':'border-orange-400'} border-orange-400   flex justify-center space-x-2 lg:px-2 py-2 px-6  items-center rounded-full  text-gray-00 text-xl hover:bg-orange-400 hover:border-orange-400 hover:text-white text-gray-50 lg:text-gray-700 lg:  lg:hover:text-gray-50 transform duration-200    `}>
            ...
            <span className={`w-full h-1 rounded-r-full bg-gray-600 ${Ham?'translate-x-28 opacity-0':''} transform duration-300 `}></span>
                ...
                <div className={`  md:hidden w-[100%]      transform duration-300 ${Ham?'translate-y-0 relative ':'-translate-y-[100vh] absolute '}    bg-gray-50  bg-opacity-50   shadow-lg  `}>
                    ...
                    <ul className="space-y-3 pt-0 ">
                        ...
                        <li className='w-full border-t last:border-b border-gray-200  px-4 h-14  ' ><NavLink to='/gallery' exact ><div className='text-gray-900 w-full h-full font-light   relative  flex justify-between items-center'  ><span className='  w-full text-xl font-semibold  ' >Gallery</span> <span className='text-2xl' ><IoIosArrowDown/></span></div></NavLink></li>
                        <li className='w-full border-t last:border-b border-gray-200  px-4 h-14  ' ><NavLink to='/contact' exact ><div className='text-gray-900 w-full h-full font-light   relative  flex justify-between items-center'  ><span className='  w-full text-xl font-semibold  ' >Contact</span> <span className='text-2xl' ><IoIosArrowDown/></span></div></NavLink></li>
                    </ul>
                </div>
