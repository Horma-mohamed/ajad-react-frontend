...
export default function Header({page}){
    ...
    <>
        <motion.nav id='navbar'  className={` fixed w-full lg:h-auto h-auto  to-transparent  backdrop   top-0 z-[9999] transform duration-500 ${fixed?'  backdrop-blur border- bg-gray-50 bg-opacity-50  border-gray-300 shadow-lg':''} `} >
            ...
            <div className="w-40  bg-gray-00 flex items-center justify-center py-4 "> 
            <img className='mx-3 w-16 ' src={'/logo.png'} alt="" srcset="" /> 
            <h1 className='mx-3 text-3xl font-karla  font-bold text-teal-900' > {t("AJAD_LOGO_TITLE")} </h1>
              </div>
            ...
            <div className=' lg:flex justify-center  px-4 hidden '>
                        {
                            socials.map((social)=>(
                               <a href="#">
                                    <div className=" group flex justify-center items-center mx-2 ">
            ...
            <span className={`w-full h-1  ${document.dir=='rtl'?'rounded-r-full':'rounded-l-full'} bg-gray-600 ${Ham?'-translate-x-28 opacity-0':''} transform duration-300 `}></span>
            <span className={`w-full h-1  ${document.dir=='rtl'?'rounded-l-full':'rounded-r-full'} bg-gray-600 ${Ham?'translate-x-28 opacity-0':''} transform duration-300 `}></span>
            </div>
                ...
                <div className={`  md:hidden w-[100%]      transform duration-300 ${Ham?'translate-y-0 relative ':'-translate-y-[100vh] absolute '}    bg-gray-50  bg-opacity-50   shadow-lg  `}>
                    ...
                    <ul className="space-y-3 pt-0 ">
                        <li className='w-full border-t last:border-b border-gray-200  px-4 h-14  ' ><NavLink to='/' exact ><div className='text-gray-900 w-full h-full font-light   relative    flex justify-between items-center'  ><span className='  w-full text-xl font-semibold  ' >{t("HOME")}</span> <span className='text-2xl' ></span> </div></NavLink></li>
                        <li className='w-full border-t last:border-b border-gray-200  px-4 h-14  ' ><NavLink to='/blog' exact ><div className='text-gray-900 w-full h-full font-light   relative  flex justify-between items-center'  ><span className='  w-full text-xl font-semibold  ' >{t("BLOG")}</span> <span className='text-2xl' ></span></div></NavLink></li>
                        <li className='w-full border-t last:border-b border-gray-200  px-4 h-14  ' ><NavLink to='/about' exact ><div className='text-gray-900 w-full h-full font-light   relative  flex justify-between items-center'  ><span className='  w-full text-xl font-semibold  ' >{t("ABOUT")}</span> <span className='text-2xl' ></span></div></NavLink></li>
                        <li className='w-full border-t last:border-b border-gray-200  px-4 h-14  ' ><NavLink to='/gallery' exact ><div className='text-gray-900 w-full h-full font-light   relative  flex justify-between items-center'  ><span className='  w-full text-xl font-semibold  ' >{t("GALLERY")}</span> <span className='text-2xl' ></span></div></NavLink></li>
                        <li className='w-full border-t last:border-b border-gray-200  px-4 h-14  ' ><NavLink to='/contact' exact ><div className='text-gray-900 w-full h-full font-light   relative  flex justify-between items-center'  ><span className='  w-full text-xl font-semibold  ' >{t("CONTACT")}</span> <span className='text-2xl' ></span></div></NavLink></li>
                    </ul>
                </div>
